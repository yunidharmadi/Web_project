...
WebUI.click(findTestObject('Page_Knockout.js  TodoMVC/label_belanja'))

WebUI.click(findTestObject('Page_Knockout.js  TodoMVC/button_belanja_destroy'))

WebUI.click(findTestObject('Page_Knockout.js  TodoMVC/label_cuci piring'))

WebUI.click(findTestObject('Page_Knockout.js  TodoMVC/button_cuci piring_destroy'))
